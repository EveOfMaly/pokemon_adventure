...
class Accounts
    ...
    def self.open_account(player)
        ...
        account = self.all.detect do |account| 
            account.user_name == player.user_name
        end

        account.game
        
        # if account.game.player == nil 
        #     account.game
        # elsif account.game.player.game == nil
        #     account.game.player.game
        # else
        #     binding.pry
        #     account.game
        # end
